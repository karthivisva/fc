...
import OpenInNewIcon from "@mui/icons-material/OpenInNew"; // 🔗 Link Icon
...
// 🎬 Keyframe Animation for Heading (Infinite Floating Effect)
    ...
    >
      ...
      <Typography 
        ...
        sx={{
          ...
          marginTop: "-80px",
          mb: 3,
          animation: `${floatingText} 2.5s infinite ease-in-out`, // 🎬 Floating Animation
        }}
      >
          ...
          {popularColleges.map((college, index) => (
            ...
            >
              ...
              <Box
                ...
                sx={{
                  width: "100%",
                  height: { xs: "350px", sm: "400px", md: "300px" }, // 📱 Increase size for mobile view
                  objectFit: "cover",
              ...
              <CardContent>
                ...
                <Button 
                  ...
                  sx={{
                    ...
                    "&:hover": { background: "linear-gradient(135deg, #0056b3, #00a6ff)" },
                  }}
